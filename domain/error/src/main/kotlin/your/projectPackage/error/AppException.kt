...
sealed class AppException(val logMessage: String?, override val cause: Throwable?) : Exception() {
    class Api(logMessage: String?, statusCode: Int, override val cause: Throwable?) :
